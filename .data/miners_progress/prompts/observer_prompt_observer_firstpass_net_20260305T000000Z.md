...
run_id: observer_firstpass_net_20260305T000000Z
objective: Discover + validate PRNewswire/GlobeNewswire/IR source schema and execute scraping where allowed.
tickers: ABTC, APLD, ARBK, BITF, BTBT, BTDR, CIFR, CLSK, CORZ, GRDI, GREE, HIVE, HUT8, IREN, MARA, MIGI, RIOT, SDIG, WULF
scout_count: 6

## Deterministic Core
- Source order: IR -> GlobeNewswire -> PRNewswire
- Exhaustion gate: max_attempts_per_source=3, max_consecutive_no_yield=2
- Coverage gate: block if no IR source and wire sample_count == 0
- Execute scrape: False
